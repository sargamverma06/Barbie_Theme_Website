  ...
  <main>
    <div class="product-container">
        <div class="product-images">
            <div class="big-img">
                <img src="images\heel1.jpg">
            </div>
            <div class="images">
                <div class="small-img">
                    <img src="images/p7.jpg" onclick="showImg(this.src)">
                </div>
                <div class="small-img">
                    <img src="images/p9.jpg" onclick="showImg(this.src)">
                </div>
                <div class="small-img">
                    <img src="images/p10.jpg" onclick="showImg(this.src)">
                </div>
            </div>
        </div>

        <div class="product-details">
            <div class="url">Home > Collection > Aldo</div>
            <div class="pname">Barbieslingb</div>
            <div class="price">$79.99</div>
            <div class="size">
                <p>Select Color:</p>
                <div class="psize ">Pink</div>
                <div class="psize">Blue</div>
                <div class="psize active">Purple</div>
            </div>
            <div class="quantity">
                <p>Quantity:</p>
