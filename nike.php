  ...
  <main>
    <div class="product-container">
        <div class="product-images">
            ...
            <div class="images">
                <div class="small-img">
                    <img src="images/p4.jpeg" onclick="showImg(this.src)">
                </div>
                <div class="small-img">
                    <img src="images/p5.jpeg" onclick="showImg(this.src)">
                </div>
                <div class="small-img">
                    <img src="images/p6.jpeg" onclick="showImg(this.src)">
                </div>
            </div>
        </div>

        <div class="product-details">
            <div class="url">Home > Collection > Nike</div>
            <div class="pname">Pink Barbie dunks</div>
